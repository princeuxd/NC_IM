...
"""
    ...
    def analyze_comments_for_brand_insights(self, comments: List[Dict], video_title: str) -> Dict:
        ...
        from prompts.comments_analysis import get_comments_sentiment_analysis_prompt
...
{get_comments_sentiment_analysis_prompt(comments_text)}

## ADDITIONAL BRAND-SPECIFIC ANALYSIS:
