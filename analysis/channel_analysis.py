...
- Community Insights: {len(community_insights)} insights collected"""
                ...
                collective_prompt = f"""Comprehensive {analysis_type} for {len(video_analyses)} videos from "{channel_title}".

CHANNEL METRICS:
- Videos Analyzed: {len(video_analyses)}
- Total Duration: {total_duration} minutes ({total_duration/60:.1f} hours)
- Average Authenticity: {avg_authenticity:.1f}/10{brand_metrics_text}
- Products/Sponsors Mentioned: {products_count}
- Content Distribution: {dict(content_type_distribution)}

DETAILED VIDEO ANALYSIS:
{chr(10).join(video_summaries)}

{"COMMUNITY CODE_INSIGHTS:" + chr(10) + chr(10).join(f"• {insight}" for insight in community_insights[:10]) if community_insights else ""}

Provide comprehensive analysis:

## Content Strategy & Focus
Analyze the overall content strategy, primary themes, and content consistency. What is their main value proposition?

## Creator Brand & Personality
Detailed analysis of the creator's communication style, personality traits, and unique voice. How do they position themselves?

## Production & Quality Standards
Assessment of production values, visual/audio quality, editing style, and overall presentation standards.

## Audience Connection & Engagement
How effectively they connect with their audience, engagement techniques used, and community building approach.

## Authenticity & Trust Factors
Analysis of content authenticity ({avg_authenticity:.1f}/10), creator genuineness, and trust-building elements with their audience.

## Commercial Content & Monetization
Products/sponsorships mentioned ({products_count} total), brand integration quality, and monetization approach.""" + (f"""

## Brand Partnership Suitability
Overall assessment for brand partnerships based on authenticity ({avg_authenticity:.1f}/10), brand safety ({avg_brand_safety:.0f}/100), and audience influence ({avg_influence:.0f}/100).

## Community & Audience Analysis  
Community engagement quality, audience authenticity, and receptivity to brand partnerships based on comments analysis.

## Creator Commercial Viability
Assessment of creator's potential for successful brand collaborations, audience trust levels, and commercial content integration.""" if is_brand_analysis else "") + f"""

## Key Strengths & Highlights
Top 3-4 things this creator does exceptionally well with specific examples (bullet points).

## Content Performance Analysis
Analysis of what content performs best and why, including engagement patterns and audience response.

Provide detailed, comprehensive insights. Each section should be 2-4 sentences with specific observations and data-driven analysis. Focus purely on analytical insights describing what exists, not what should be improved or recommended."""
